            ...
            <div className="max-w-2xl w-full text-center space-y-8 md:space-y-16">
              <div className="relative inline-block">
                <motion.div 
                  ...
                  className="absolute -inset-10 md:-inset-16 border border-amber-500/5 rounded-full"
                />
                <motion.div 
                  animate={{ rotate: -360 }}
                  transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                  className="absolute -inset-6 md:-inset-8 border border-amber-500/10 rounded-full border-dashed"
                />
                <div 
                ...
                >
                  ...
                  {isScanning ? (
                    <motion.div 
                      ...
                      className="z-10"
                    >
                      <Fingerprint className="w-12 h-12 sm:w-20 sm:h-20 text-amber-500" />
                    </motion.div>
                  ) : challengeStep === 0 ? (
                    <motion.div
                    ...
                    <ShieldCheck className="w-12 h-12 sm:w-20 sm:h-20 text-amber-500/20" />
                  ) : (
              ...
              <div className="glass-card p-6 sm:p-12 space-y-8 sm:space-y-10 border-white/5 relative overflow-hidden mx-2 sm:mx-0">
                ...
                {challengeStep === 0 && (
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-10">
                    <p className="text-sm sm:text-lg font-light text-amber-100/60 leading-relaxed">
                ...
                {challengeStep === 1 && (
                  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-10">
                    <p className="text-lg sm:text-2xl font-serif font-light text-amber-100/80 italic leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      <button
                        ...
                        className="w-full py-4 sm:py-5 border border-amber-500/20 text-amber-500 font-bold uppercase tracking-[0.18em] sm:tracking-[0.2em] text-[10px] hover:bg-amber-500/5 transition-colors"
                      >
          ...
          >
              ...
              <div className="w-full lg:w-1/2 min-h-[66vh] lg:min-h-screen flex flex-col justify-center px-6 sm:px-12 lg:px-24 py-16 lg:py-24 relative order-1 lg:order-2">
                ...
                >
                  ...
                  <div className="max-w-md space-y-5 sm:space-y-8">
                    <p className="text-base sm:text-xl md:text-2xl text-amber-100/60 font-light leading-relaxed italic">
                    ...
                    <div className="flex items-center gap-6">
                      <span className="text-[9px] sm:text-[10px] uppercase tracking-[0.3em] sm:tracking-[0.4em] text-amber-500/40 font-black">From Hội 12 Người</span>
                    </div>
                  </div>
                </motion.div>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 py-20 sm:py-48">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-24 items-start mb-16 sm:mb-32">
                ...
                <div className="lg:col-span-5 pt-4 sm:pt-12">
                  <p className="text-amber-100/40 text-base sm:text-lg leading-relaxed font-light italic border-l border-amber-500/20 pl-4 sm:pl-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 border-t border-white/10">
                {messages.map((msg, index) => (
                  ...
                  >
                    ...
                    <p className="text-base sm:text-xl text-amber-50/70 leading-relaxed font-light italic group-hover:text-white transition-colors">
                      “{msg}”
                    </p>
            ...
            <section className="py-24 sm:py-72 px-4 sm:px-6 relative overflow-hidden">
              <div className="absolute inset-0 z-0">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[320px] h-[320px] sm:w-[800px] sm:h-[800px] bg-amber-500/5 rounded-full blur-[120px] sm:blur-[180px]" />
              </div>
              ...
              <div className="max-w-5xl mx-auto text-center relative z-10">
                ...
                >
                  ...
                  <div className="space-y-8 sm:space-y-12">
                    ...
                    <div className="h-20 sm:h-32 w-px bg-gradient-to-b from-amber-500/40 to-transparent mx-auto" />
                    <p className="text-lg sm:text-2xl md:text-3xl text-amber-100/40 font-light italic max-w-2xl mx-auto leading-relaxed">
